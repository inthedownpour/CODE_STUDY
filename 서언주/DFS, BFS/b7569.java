...
// 3차원 배열을 사용 board[면][세로][가로] z,x,y
// 토마토가 익으면 1, 안익으면 0, 없으면 -1을 입력, 익은게 있으면 큐에 넣음
// 큐에서 익은 토마토를 꺼내서 6방향(상 하 좌 우 위 아래)를 돌면서
// 토마토가 안 익은게 있으면 큐에 넣고 익었다고 기존 값에 1을 넣음
// 그 후, 토마토 판을 돌면서 0이 있으면 안익은게 있기 때문에 -1을 출력
// result가 1이라면 토마토가 다 익은 상태이기 때문에 0 출력
